...
// Cette classe repr�sente une variante des valeurs Minimax.
public class Triplet {
  ...
  // Le minimum de points que le joueur bleu aura � la fin du jeu si le joueur bleu
  // joue parfaitement.
  private int minBlue;

  // Le minimum de points que le joueur orange aura � la fin du jeu si le joueur
  // orange joue parfaitement.
  private int minOrange;

  // Initialise une valeur Minimax tel que:

  // 1) isLeftMove vaut true si le meilleur coup � jouer est � gauche.isLeftMove vaut false sinon.
  // 2) Le minimum de points que le joueur bleu aura � la fin du jeu si le joueur
  // bleu joue parfaitement vaut minBlue.
  // 3) Le minimum de points que le joueur orange aura � la fin du jeu si le joueur
