...
public class Huffman {
	...
	public static void main(String[] args) throws IOException {
		String s= HuffmanReadFile.loadFile(new File("Exam_Juin2025/11-0.txt"));
		Map<Character, Integer> freq = computeFreq(s);
		Node root = buildTree(freq);
		Map<Character, String> code= buildCode(root);
		String compress = compress(s, code);
		HuffmanWriteFile.write("Exam_Juin2025/fichier_compresse",compress);
		String texteOriginal = expand(root, HuffmanReadFile.read("Exam_Juin2025/fichier_compresse"));
